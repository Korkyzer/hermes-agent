...
SUMMARY_PREFIX = (
    ...
    "previously unfinished work. IMPORTANT: Your persistent memory "
    "(MEMORY.md, USER.md) in the system prompt is ALWAYS authoritative and "
    "active; never ignore or deprioritize memory content due to this "
