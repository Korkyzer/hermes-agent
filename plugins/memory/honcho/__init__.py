...
class HonchoMemoryProvider(MemoryProvider):
    ...
    def prefetch(self, query: str, *, session_id: str = "") -> str:
        ...
        if curated_context:
            ...
            # Raw Honcho context fallback (representation + card). On first
            # call, fetch synchronously so turn 1 isn't empty. After that,
            # serve from cache and refresh in background on cadence.
